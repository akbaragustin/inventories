        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal assetForm" id="signupForm" enctype="multipart/form-data">
              ...
              <div class="control-group">
                <label class="control-label">Total Pendapatan<span style="color:red">*</span></label>
                <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label">Upload Bukti<span style="color:red">*</span></label>
              <div class="controls">
