...
<body style="background-color:white">
    <div class="main-content">
        <!-- <div class="container">   -->
            ...
            <!-- </div> -->
            <br><br><br>
             <center> DETAIL PEMBELANJAAN </center>
            <br/>
            <div class="row" style="padding-right:25px;padding-left:25px">
                <div class="cols-xs-12">
                    <table border="0" style="width:90%" class="dataTablesRapat table table-striped js-basic-example listTable no-footer">
                        <tr>
                        ...
                        <tr>
                        <td colspan="3"><center>  PEMBELANJAAN </center> </td>
                        </tr>
                      ...
                      <center> <img src="{{URL::asset('')}}uploads/picture/{{$data['file_path']}}" alt="" style="width:50%" class="img"></center>
                </div>
            </div>
        <!-- </div> -->
    </div>
