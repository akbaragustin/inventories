        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal signupForm" id="signupForm" enctype="multipart/form-data">
              ...
              <div class="control-group">
                <label class="control-label">Satuan Bahan</label>
                <div class="controls">
...
<script>
  var urlSave ="{{url(route('goods.create'))}}";
  var  urlEdit = "{{url('/admin/goods/edit')}}";
  var  urlDelete = "{{url('/admin/goods/delete')}}";
  $('#myTable').DataTable();
 //this is validation jquery
  $('#signupForm').validate({
          ...
          messages: {
              ...
              unit :{
                  required : "Please enter your satuan bahan",
              },
